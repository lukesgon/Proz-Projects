...
let elementOrdenedList = document.querySelector("ol");
let elementUnordenedList = document.querySelector("ul");

elementH1.innerText = "Novo Título";

elementA.innerText = "Novo Link";

elementOrdenedList.innerHTML = `
<li>Primeiro item</li>
<li>Segundo item</li>
<li>Terceiro item</li>
`
elementUnordenedList.innerHTML = `
